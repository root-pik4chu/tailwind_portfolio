                      ...
                      <div className="w-full ">
                        <div className="text has-before-line !mt-15 text-white p-2 ">
                          ...
                          <p className="text-lg leading-relaxed text-white !mt-5 section-after">
                            ...
                            experience. I take pride in delivering interface
                            that look stunning perform smoothly and reflect
                            Attraction to details.i am to merge clean design
                            fliud animation to create experience
                          </p>
                        </div>
                      </div>
                    </div>
